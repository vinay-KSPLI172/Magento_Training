...
use Ksolves\News\Model\Allnews;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Ksolves\News\Model\AllnewsFactory $allnewsFactory = null,
        \Ksolves\News\Api\AllnewsRepositoryInterface $allnewsRepository = null
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->allnewsFactory = $allnewsFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Ksolves\News\Model\AllnewsFactory::class);
        $this->allnewsRepository = $allnewsRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Ksolves\News\Api\AllnewsRepositoryInterface::class);
	...
	{
		return $this->_authorization->isAllowed('Ksolves_News::save');
	}
